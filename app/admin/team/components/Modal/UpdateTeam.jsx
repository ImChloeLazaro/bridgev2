...
const UpdateTeam = ({ onOpenChange, isOpen, teamData, updateTeamInList }) => {
  const [team, setTeam] = useState(
    teamData || { name: "", client: "", heads: [], members: [] }
  );

//   team.members.map((member) => {
//     console.log("the members are" + member._id)
//   })
...
//   team.members.map((member) => {
//     console.log("the members are" + member.name);
//   });
        ...
        <div className="flex flex-col space-y-4">
          ...
          <DepartmentSelect
            ...
            handleInvitees={(selected) =>
              setTeam({ ...team, department: selected })
            }
