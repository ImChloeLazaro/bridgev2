...
const AddSubTeamModal = ({ addSubTeam }) => {
    ...
    const onsubmit = async (e) => {
        ...
        try {
            const team = await restinsert('/teams/sub-team/', subteam_entry)
        ...
        <>
            ...
            <ModalComponent
                ...
                <div className="flex flex-col space-y-4">
                    <Input type="text" label="Team Name" size="sm" onChange={e => setTeamMembers({ ...teamMembers, name: e.target.value })} />
                    <MemberSelect
