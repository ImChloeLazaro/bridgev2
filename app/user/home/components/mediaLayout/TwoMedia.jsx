...
const TwoMedia = ({ data, orientation, layout }) => {
  ...
  const alignment = {
    landscape:
      "gap-1.5 grid grid-cols-1 grid-rows-2 bg-white-default/60 h-full px-0 lg:px-4",
    portrait:
      "gap-1.5 grid grid-cols-2 grid-rows-1 bg-white-default/60 h-full px-0 lg:px-4",
  };
