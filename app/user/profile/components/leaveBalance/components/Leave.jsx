            ...
            {data && (
              <>
                <Select
                  ...
                  isDisabled
                >
                  <SelectItem key="default">{data.leaveType}</SelectItem>
                </Select>
                <Select
                  ...
                  isDisabled
                >
                  <SelectItem key="default">{data.numOfHours}</SelectItem>
                </Select>
                <DateInput
                  label={"Leave Date"}
                  isDisabled
                ...
                <div className="flex justify-between">
                  ...
                  <Chip
                    color={`${
                      data.tlApproval == "pending"
                        ? "warning"
                        : data.tlApproval == "approved"
                        ? "success"
                        : "danger"
                    }`}
                  >{`${data.tlApproval}`}</Chip>
                </div>
                <div className="flex justify-between">
                  <p>Admin Approval: </p>
                  <Chip
